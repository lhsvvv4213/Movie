...
<body class="join">
	<div class="l_wrapper">
		<div class="inner">
				...
				<form action="/Movie/Register_Success.movie" id="myForm">
					<div class="join_step3">
						<ul>
							<li id="li_id list_input"> 
								<input type="text" name="member_id" placeholder="아이디" class="join_cheak_id in_e_sel_menu" id="mem_id" minlength="8" maxlength="30" required>
								<button type="button" name="idDuplication" class="id_user tit_14" onclick="idCheck()">중복체크</button>
							</li>
							<li id="li_pw list_input">
								<input type="password" name="member_pw" placeholder="비밀번호" class="cheakpw in_e_sel_menu" minlength="8" maxlength="20" required>
							</li>
					...
					<div class="join_step4">
						<ul>
							<li id="li_name list_input">
								<input type="text" name="member_name" placeholder="이름" class="cheakname in_e_sel_menu" size="10" maxlength="20" required>              
							</li>
							<li id="li_mail list_input"> 
								<input type="email" name="member_email" placeholder="abc@abc.com" class="cheakemail in_e_sel_menu" id="mem_email" size="70" maxlength="40" required>
							</li>
							<li id="li_number list_input">
								<input type="text"name="member_phone" placeholder="핸드폰 번호를 -없이 입력해주세요." class="cheakenumber in_e_sel_menu" maxlength="20" required>
							</li>
						</ul>
					</div>
